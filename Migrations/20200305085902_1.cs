        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    DateCreated = table.Column<DateTime>(nullable: false),
                    User_one_id = table.Column<Guid>(nullable: false),
                    User_two_id = table.Column<Guid>(nullable: false),
                    Action_user_id = table.Column<Guid>(nullable: false),
                    Status = table.Column<int>(nullable: false),
                    DateModified = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    RoomChatId = table.Column<string>(nullable: true),
                    AppUserId = table.Column<Guid>(nullable: false),
                    RoomChatId1 = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserChats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUserChats_AppUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    RomChat_Id = table.Column<int>(nullable: false),
                    ...
                    Attach_url = table.Column<string>(nullable: true),
                    DateCreated = table.Column<DateTime>(nullable: false),
                    DateModified = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_RoomChats_RomChat_Id",
                        column: x => x.RomChat_Id,
                        principalTable: "RoomChats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
